...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: 12, fontSize: 18, fontFamily: "Montserrat_400Regular", color: colors.textPrimary, backgroundColor: colors.surface },
