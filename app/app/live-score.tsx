...
const styles = StyleSheet.create({
  ...
  outcomeGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 12 },
  outcomeButton: {
    width: "23%",
    aspectRatio: 1.4,
    borderWidth: 1,
  ...
  outcomeButtonText: { color: colors.textPrimary, fontFamily: "Montserrat_700Bold", fontSize: 16 },
  ...
  undoButton: { alignSelf: "flex-start", marginTop: 16, paddingVertical: 6 },
  undoButtonText: { color: colors.danger, fontFamily: "Montserrat_600SemiBold" },
