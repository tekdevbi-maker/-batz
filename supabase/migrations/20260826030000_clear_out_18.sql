...
-- 20260825170000_clear_out_17.sql -- clears all test teams/players/games/
-- coaches/members and every account except atbatz@brain-spell.com, keeps
-- the League/Division catalog intact.
do $$
declare
  v_keep_user uuid;
begin
