...
-- 20260728130000_clear_out_3.sql / 20260729120000_clear_out_4.sql -- clears
-- all test teams/players/games/coaches/members and every account except
-- tekdevbi@gmail.com, keeps the League/Division catalog intact.
do $$
declare
  v_keep_user uuid;
begin
